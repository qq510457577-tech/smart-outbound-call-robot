...
class OutboundBotClient:
    ...
    def save_contact_white_list(
        ...
        req = outbound_models.SaveContactWhiteListRequest(
            instance_id=instance_id, contact_list=contact_list
        )
    ...
    def download_recording(self, instance_id: str, job_id: str) -> Dict:
        """获取录音下载链接"""
    ...
    def dialogue(
        ...
        utterance: str, calling_number: str, called_number: str,
    ) -> Dict:
        """对话交互（实时对话接口）"""
